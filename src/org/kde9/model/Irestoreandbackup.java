...
class Irestoreandbackup 
implements Constants, RestoreAndBackup {
	
	private Irestoreandbackup() {}
	...
	public static Irestoreandbackup createIrestoreandbackup() {
		return new Irestoreandbackup();
	}
	...
	public static void main(String args[]) {
		RestoreAndBackup rab = new Irestoreandbackup();
		try {
			rab.checkout();
		} catch (IOException e) {
